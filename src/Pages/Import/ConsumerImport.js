   ...
   const handleImportConsumer=(e)=>{
    ...
    fetch('https://pbsofficeinfosql.onrender.com/import-csv', {
            ...
            .then(data => {
                ...
                e.target.reset();
                // setData("");
                toast("Data Import Successfully!");
            })
   }
    return (
        <div className='container '>
            <div className='d-flex flex-column justify-content-center align-items-center'>
                <h1 className='m-3'>Upload Consumer Here</h1>
                <form onSubmit={handleImportConsumer}>
                    <input 
                    ...
                    <input type='submit' className='btn btn-primary' value='Import Bill'></input> 
                </form>
                <br/>
